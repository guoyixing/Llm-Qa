...
### hisense-ids-app-spec-PERF-001 IBA 集合查询使用项目批量能力

- 标签：hisense-ids-app-spec-PERF-001
- 级别：REQUIRED
...
- 来源：`data/code/hisense-ids-app-spec/hisense-app/src/main/java/com/glaway/common/utils/IbaValueQueryUtil.java:25-46,86-198`；`data/code/hisense-ids-app-spec/hisense-app/src/main/java/com/glaway/common/utils/TypeAttrDefinitionQueryUtil.java:25-46,94-188`

### hisense-ids-app-spec-PERF-002 规格书多行处理先批量加载并建立索引

- 标签：hisense-ids-app-spec-PERF-002
- 级别：REQUIRED
